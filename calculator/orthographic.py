...
def calculate_old20(words, corpus):
    corpus_series = pl.Series(corpus)
    results = process_words(words, corpus_series, 'old20')
...
def calculate_neighborhood_frequency(words, corpus, frequencies):
    ...
    results = []
    for chunk in tqdm(chunks, desc="Calculating orthographic neighborhood frequency"):
